...
import com.bd.base.report.ExtentManager;
...
public class TestBase {
   ...
   // public void clickOnLinkText(String lnkTxt) { driver.findElement(By.linkText(lnkTxt)).click(); }
   // public void clickOnId(String idname) { driver.findElement(By.id(idname)).click(); }
   // public void clickOnXpath(String xpth) { driver.findElement(By.xpath(xpth)).click();}
    // public void typeOnXpath(String tpath, String data){ driver.findElement(By.xpath(tpath)).sendKeys(data); }
    //screenshot
    ...
    public ArrayList<String> conectionAndGetDataFromDataBase() throws SQLException {
        ...
        //4 steps you need if you want to connect and get data from data bas e
        // conection
        // create statment
        // create your result set
        //close connexion
        Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3306/peoplentech","root","root1234");
        Statement st = con.createStatement();
        ResultSet res = st.executeQuery("select * from testdata;");
        while (res.next()){
            data.add(res.getString("bookname"));
